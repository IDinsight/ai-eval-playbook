...
* [Overview](level-1-model-evaluation/overview/README.md)
...
* [How is Level 1 evaluation performed?](level-1-model-evaluation/how-is-level-1-evaluation-performed/README.md "How to evaluate?")
  ...
  * [3. Develop a golden dataset](level-1-model-evaluation/how-is-level-1-evaluation-performed/3.-develop-a-golden-dataset.md)
  * [4. Scoring & error analysis](level-1-model-evaluation/how-is-level-1-evaluation-performed/4.-scoring-and-error-analysis.md)
  * [5. Automate your evaluations](level-1-model-evaluation/how-is-level-1-evaluation-performed/5.-automate-your-evaluations.md)
  * [6. Red-teaming](level-1-model-evaluation/how-is-level-1-evaluation-performed/6.-red-teaming.md)

## Level 2 - Product Evaluation

* [Overview](level-2-product-evaluation/overview/README.md)
  * [Why is this level of evaluation important?](level-2-product-evaluation/overview/why-is-this-level-of-evaluation-important.md "Why is this important?")
  * [Who is most involved in this level of evaluation?](level-2-product-evaluation/overview/who-is-most-involved-in-this-level-of-evaluation.md "Who is involved in this evaluation?")
  * [What is the “Product” being evaluated?](level-2-product-evaluation/overview/what-is-the-product-being-evaluated.md "What is the “Product”?")
  * [What is the Minimum Viable Evaluation in Level 2?](level-2-product-evaluation/overview/what-is-the-minimum-viable-evaluation.md "Minimum Viable Evaluation")
* [How is Level 2 evaluation performed?](level-2-product-evaluation/how-is-level-2-evaluation-performed/README.md "How to evaluate")
  * [Methods for experimentation: A/B testing and beyond](level-2-product-evaluation/how-is-level-2-evaluation-performed/methods-for-experimentation-a-b-testing-and-beyond.md "Methods for experimentation")
  * [Connection with other levels](level-2-product-evaluation/how-is-level-2-evaluation-performed/connection-with-other-levels.md)
  * [Why Aren’t Users Engaging?](level-2-product-evaluation/how-is-level-2-evaluation-performed/why-arent-users-engaging.md)
...
* [Overview](level-3-user-evaluation/overview/README.md)
  ...
  * [What is the Minimum Viable Evaluation in Level 3?](level-3-user-evaluation/overview/what-is-the-minimum-viable-evaluation.md "Minimum Viable Evaluation")
* [How is Level 3 evaluation performed?](level-3-user-evaluation/how-is-level-3-evaluation-performed/README.md "How to evaluate")
  * [Identify outcome metrics](level-3-user-evaluation/how-is-level-3-evaluation-performed/descriptive-analysis.md)
...
* [Overview](level-4-impact-evaluation/overview/README.md)
  * [Why is this level of evaluation important?](level-4-impact-evaluation/overview/why-is-this-level-of-evaluation-important.md "Why is this important?")
