...
End-to-end, the entire Level 1 evaluation workflow is both complex and highly iterative (see Figure x). However, we encourage you to start with a [Minimum Viable Evaluation](../../references/minimum-viable-evaluations.md), and build incrementally as the product matures.

<figure><img src="../../.gitbook/assets/image.png" alt=""><figcaption><p>Figure 7: Level 1 Evals Workflow</p></figcaption></figure>
...
{% step %}
### [Automate your evaluations](./#automate-your-evaluations)
